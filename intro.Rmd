...
$$\hat\Lambda_0(t) = \int_0^t \frac{\sum_i e^{z_i\beta}d N_i(s)}{\sum_i e^{z_i\beta} Y_i(s)}$$
...
$$p(\beta)= \frac{\lambda_0(t)e^{z_i(t)\beta}}{\sum_{\textrm{alive at } t} \lambda_0(t)e^{z_j(t)\beta}}=\frac{e^{z_i(t)\beta}}{\sum_{\textrm{alive at } t} e^{z_j(t)\beta}}$$
...
$$p(\beta)= \frac{\lambda_0(t)e^{z_i(t)\beta}}{\sum_{\textrm{observed at } t} \lambda_0(t)e^{z_j(t)\beta}}=\frac{e^{z_i(t)\beta}}{\sum_{\textrm{observed at } t} e^{z_j(t)\beta}}$$

...
Big precision gains for coefficients of variables we have on the whole cohort or can predict well (eg self-report vs measured)

(Breslow et al, 2009 *Am J Epi*)
...
There are a few important differences due to  censoring, competing risks, truncation.

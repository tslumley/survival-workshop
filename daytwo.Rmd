...
**Crude incidence**: what proportion of people get/don't get local recurrence or stroke by time $t$? Unlike $S(t)$, won't go all the way to zero for large $t$. 

**Cause-specific hazard**: rate of events from a specific cause 
...
- group 1: rates of 3 (per decade, 30%/year) for cancer and non-cancer deaths
- group 2: cancer rate of 2, non-cancer rate of 1 (per decade)

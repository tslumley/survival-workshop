...
- people at the same time after a fixed time zero? (eg, same age). Start time for next data record is time of event for past record
- people at the same time after their previous event? (eg, same recovery time). Start time for next data row is record
